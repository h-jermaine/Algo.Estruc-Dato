...
LRESULT CALLBACK WindowProcedure (HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    M.Insertar ("B", "q4", "q4,B,S");
    M.Insertar ("0", "q4", "q4,0,S");
    M.Insertar ("1", "q4", "q4,1,S");
    M.Insertar ("X", "q4", "q4,X,S");
    M.Insertar ("Y", "q4", "q4,Y,S");
    ...
    switch (message)                  /* handle the messages */
    {
        case WM_CREATE:{
            ...
            /*estadoMt = CreateWindowEx(0, _T("STATIC"), _T("Est: "), SS_CENTER|SS_NOTIFY|WS_CHILD|WS_VISIBLE|WS_TABSTOP, 290, 105, 25, 20,
                                     hwnd, 0, 0, 0)*/
        ...
        case WM_PAINT:
            ...
            switch(Comando){
                ...
                case BT3:{
                    filedit = GetDlgItem(hwnd, CAJALEER); // I tried with and without this
                    GetWindowText(filedit, textoCajaWM, sizeof(textoCajaWM));
                    std::string textoCajaWMcp = textoCajaWM;
                    if(textoCajaWMcp != "")
